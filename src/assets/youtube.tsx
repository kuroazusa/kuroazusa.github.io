export function YouTubeIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="socialmediaicon" onClick={() => window.open("https://www.youtube.com/channel/UCwWT0Vpq-TvZps_F4Go96qQ")}>
